		...
		this.config = {
			header: {
				...
				items: [
					...
					{
					  title: 'Feingkai Exchange', // <= Title of the page
					  desc: 'The best Crypto Exchange in the world', // <= Description of the page
					  root: true,
					  page: '/feingkai', // <= URL
					  icon: 'flaticon-line-graph' // <= Choose the icon
					},
					// {
					// 	title: 'Feingkai Exchange Login', // <= Title of the page
					// 	desc: 'The best Crypto Exchange in the world', // <= Description of the page
					// 	root: true,
					// 	page: '/feingkai/login', // <= URL
					// 	icon: 'flaticon-line-graph' // <= Choose the icon
					// },
							{
						title: 'Actions',
